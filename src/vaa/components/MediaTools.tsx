...
export const CameraCapture: React.FC<CameraCaptureProps> = ({ onClose, agents, onSend }) => {
  ...
  return (
    ...
    >
      <div className="absolute top-6 left-6 right-6 flex justify-between items-center z-[210] pt-safe">
        <button 
          onClick={(e) => {
            e.stopPropagation();
            onClose();
      ...
      <div className="p-8 bg-black/40 backdrop-blur-xl border-t border-white/10 pb-safe">
        {!capturedImage ? (
...
export const QRScanner: React.FC<QRScannerProps> = ({ onClose, onScan }) => {
  ...
  return (
    ...
    >
      ...
      <div className="p-10 bg-black/40 backdrop-blur-xl border-t border-white/10 flex flex-col items-center gap-6 pb-safe">
